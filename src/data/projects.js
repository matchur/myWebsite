export const projects = [
  ...
  },
  {
    ...
    title: 'DoeJá',
    description:
      'Projeto de incubação UTFPR para facilitar doações a entidades e pessoas em situação emergencial.',
    technologies: ['TypeScript', 'TypeORM', 'React', 'Docker', 'MongoDB', 'MySQL'],
    externalLinks: [
